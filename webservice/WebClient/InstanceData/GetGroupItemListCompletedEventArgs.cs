...
// Type: InstanceData.GetGroupItemListCompletedEventArgs
...
namespace InstanceData
{
  ...
  public class GetGroupItemListCompletedEventArgs : AsyncCompletedEventArgs
  {
    ...
    internal GetGroupItemListCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState)
