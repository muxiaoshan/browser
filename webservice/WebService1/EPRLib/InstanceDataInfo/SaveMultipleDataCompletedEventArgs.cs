...
namespace InstanceDataInfo
{
	...
	public class SaveMultipleDataCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		internal SaveMultipleDataCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState) : base(exception, cancelled, RuntimeHelpers.GetObjectValue(userState))
		{
