...
namespace SysOptionData
{
	...
	public class GetValueByNameCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		internal GetValueByNameCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState) : base(exception, cancelled, RuntimeHelpers.GetObjectValue(userState))
		{
