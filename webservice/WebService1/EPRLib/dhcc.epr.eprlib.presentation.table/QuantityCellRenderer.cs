...
{
	public class QuantityCellRenderer : GridTextBoxCellRenderer
	{
		public QuantityCellRenderer(GridControlBase grid, GridTextBoxCellModel cellModel) : base(grid, cellModel)
		{
			this.AddButton(new QuantityButton(this));
		}
