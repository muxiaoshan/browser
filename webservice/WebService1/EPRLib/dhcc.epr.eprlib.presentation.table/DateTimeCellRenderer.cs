...
{
	public class DateTimeCellRenderer : GridTextBoxCellRenderer
	{
		public DateTimeCellRenderer(GridControlBase grid, GridTextBoxCellModel cellModel) : base(grid, cellModel)
		{
			this.AddButton(new DateTimeButton(this));
		}
