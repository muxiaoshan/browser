...
{
	public class MultiChoiceCellRenderer : GridTextBoxCellRenderer
	{
		public MultiChoiceCellRenderer(GridControlBase grid, GridTextBoxCellModel cellModel) : base(grid, cellModel)
		{
			this.AddButton(new MultiChoiceButton(this));
		}
