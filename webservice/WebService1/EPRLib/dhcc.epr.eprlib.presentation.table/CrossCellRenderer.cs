...
{
	public class CrossCellRenderer : GridGenericControlCellRenderer
	{
		public CrossCellRenderer(GridControlBase grid, GridGenericControlCellModel cellModel) : base(grid, cellModel)
		{
			this.AddButton(new CrossButtion(this));
		}
