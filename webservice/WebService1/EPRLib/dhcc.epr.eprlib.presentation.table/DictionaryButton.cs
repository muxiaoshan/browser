...
{
	public class DictionaryButton : GridCellButton
	{
		private static GridIconPaint iconPainter;

		static DictionaryButton()
		{
			DictionaryButton.iconPainter = new GridIconPaint("", typeof(DictionaryButton).Assembly);
		}

		public DictionaryButton(GridTextBoxCellRenderer control) : base(control)
		{
		}
		...
		public override void Draw(Graphics g, int rowIndex, int colIndex, bool bActive, GridStyleInfo style)
		{
			...
			string text = "Dictionary.bmp";
			DictionaryButton.iconPainter.PaintIcon(g, this.get_Bounds(), empty, text, Color.Blue);
		}
	}
}
