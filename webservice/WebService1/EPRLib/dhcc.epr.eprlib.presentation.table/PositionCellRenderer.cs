...
{
	public class PositionCellRenderer : GridTextBoxCellRenderer
	{
		public PositionCellRenderer(GridControlBase grid, GridTextBoxCellModel cellModel) : base(grid, cellModel)
		{
			this.AddButton(new PositionButton(this));
		}
