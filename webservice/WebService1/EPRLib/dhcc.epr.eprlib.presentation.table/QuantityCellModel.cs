...
{
	[Serializable]
	public class QuantityCellModel : GridTextBoxCellModel
	{
		protected QuantityCellModel(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			Size buttonBarSize = new Size(20, 20);
			base.set_ButtonBarSize(buttonBarSize);
		}

		public QuantityCellModel(GridModel grid) : base(grid)
		{
		}

		public override GridCellRendererBase CreateRenderer(GridControlBase control)
		{
			return new QuantityCellRenderer(control, this);
		}
