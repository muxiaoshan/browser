...
{
	[Serializable]
	public class DictionaryCellModel : GridTextBoxCellModel
	{
		protected DictionaryCellModel(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			Size buttonBarSize = new Size(20, 20);
			base.set_ButtonBarSize(buttonBarSize);
		}

		public DictionaryCellModel(GridModel grid) : base(grid)
		{
		}

		public override GridCellRendererBase CreateRenderer(GridControlBase control)
		{
			return new DictionaryCellRenderer(control, this);
		}
