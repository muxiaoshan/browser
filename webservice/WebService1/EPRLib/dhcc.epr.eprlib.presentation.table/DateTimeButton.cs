...
{
	public class DateTimeButton : GridCellButton
	{
		private static GridIconPaint iconPainter;

		static DateTimeButton()
		{
			DateTimeButton.iconPainter = new GridIconPaint("", typeof(DateTimeButton).Assembly);
		}

		public DateTimeButton(GridTextBoxCellRenderer control) : base(control)
		{
		}
		...
		public override void Draw(Graphics g, int rowIndex, int colIndex, bool bActive, GridStyleInfo style)
		{
			...
			string text = "DateTime.bmp";
			DateTimeButton.iconPainter.PaintIcon(g, this.get_Bounds(), empty, text, Color.Blue);
		}
	}
}
