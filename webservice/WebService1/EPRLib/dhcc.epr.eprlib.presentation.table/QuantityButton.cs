...
{
	public class QuantityButton : GridCellButton
	{
		private static GridIconPaint iconPainter;

		static QuantityButton()
		{
			QuantityButton.iconPainter = new GridIconPaint("", typeof(QuantityButton).Assembly);
		}

		public QuantityButton(GridTextBoxCellRenderer control) : base(control)
		{
		}
		...
		public override void Draw(Graphics g, int rowIndex, int colIndex, bool bActive, GridStyleInfo style)
		{
			...
			string text = "Quantity.bmp";
			QuantityButton.iconPainter.PaintIcon(g, this.get_Bounds(), empty, text, Color.Blue);
		}
	}
}
