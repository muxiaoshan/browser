...
{
	public class MultiChoiceButton : GridCellButton
	{
		private static GridIconPaint iconPainter;

		static MultiChoiceButton()
		{
			MultiChoiceButton.iconPainter = new GridIconPaint("", typeof(MultiChoiceButton).Assembly);
		}

		public MultiChoiceButton(GridTextBoxCellRenderer control) : base(control)
		{
		}
		...
		public override void Draw(Graphics g, int rowIndex, int colIndex, bool bActive, GridStyleInfo style)
		{
			...
			MultiChoiceButton.iconPainter.PaintIcon(g, this.get_Bounds(), empty, text, Color.Blue);
		}
	}
}
