...
namespace GateWayDataInfo
{
	...
	public class GetParameterStringCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		internal GetParameterStringCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState) : base(exception, cancelled, RuntimeHelpers.GetObjectValue(userState))
		{
