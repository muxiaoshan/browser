...
namespace InterfaceTemplateData
{
	...
	public class CreateTemplateCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		internal CreateTemplateCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState) : base(exception, cancelled, RuntimeHelpers.GetObjectValue(userState))
		{
