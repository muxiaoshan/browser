...
{
	public class MetaItemIconWidthTypeEditor : UITypeEditor
	{
		...
		public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
		{
			if (context != null & context.Instance != null & provider != null)
			{
				...
				MetaItemPropertyWrap metaItemPropertyWrap = (MetaItemPropertyWrap)context.Instance;
				if (this.edSvc != null)
				{
					UCLineWidth uCLineWidth = new UCLineWidth(metaItemPropertyWrap.BorderWidth);
