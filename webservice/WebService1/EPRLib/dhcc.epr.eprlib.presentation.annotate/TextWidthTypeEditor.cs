...
{
	public class TextWidthTypeEditor : UITypeEditor
	{
		...
		public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
		{
			if (context != null & context.Instance != null & provider != null)
			{
				...
				TextPropertyWrap textPropertyWrap = (TextPropertyWrap)context.Instance;
				if (this.edSvc != null)
				{
					UCLineWidth uCLineWidth = new UCLineWidth(textPropertyWrap.LineWidth);
