...
{
	public class EPRHotSpotEllipse : EllipseAnnotation, IEPRHotSpot
	{
		...
		public override string ToXmp()
		{
			...
			stringBuilder.Append("<ann:CustomAnnotation AssemblyType=\"EPRLib,dhcc.epr.eprlib.presentation.annotate.EPRHotSpotEllipse\">");
