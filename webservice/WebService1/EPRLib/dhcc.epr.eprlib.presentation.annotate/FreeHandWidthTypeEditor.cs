...
{
	public class FreeHandWidthTypeEditor : UITypeEditor
	{
		...
		public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
		{
			if (context != null & context.Instance != null & provider != null)
			{
				...
				FreeHandPropertyWrap freeHandPropertyWrap = (FreeHandPropertyWrap)context.Instance;
				if (this.edSvc != null)
				{
					UCLineWidth uCLineWidth = new UCLineWidth(freeHandPropertyWrap.LineWidth);
