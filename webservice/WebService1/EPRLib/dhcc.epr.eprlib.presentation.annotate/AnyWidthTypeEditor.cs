...
{
	public class AnyWidthTypeEditor : UITypeEditor
	{
		...
		public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
		{
			if (context != null & context.Instance != null & provider != null)
			{
				...
				AnyPropertyWrap anyPropertyWrap = (AnyPropertyWrap)context.Instance;
				if (this.edSvc != null)
				{
					UCLineWidth uCLineWidth = new UCLineWidth(anyPropertyWrap.LineWidth);
