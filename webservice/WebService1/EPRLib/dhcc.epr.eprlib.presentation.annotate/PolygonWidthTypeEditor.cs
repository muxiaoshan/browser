...
{
	public class PolygonWidthTypeEditor : UITypeEditor
	{
		...
		public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
		{
			if (context != null & context.Instance != null & provider != null)
			{
				...
				PolygonPropertyWrap polygonPropertyWrap = (PolygonPropertyWrap)context.Instance;
				if (this.edSvc != null)
				{
					UCLineWidth uCLineWidth = new UCLineWidth(polygonPropertyWrap.LineWidth);
