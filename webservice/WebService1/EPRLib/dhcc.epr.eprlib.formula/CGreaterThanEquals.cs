...
{
	public class CGreaterThanEquals : COperator
	{
		private CValue m_arg1;

		private CValue m_arg2;

		public CGreaterThanEquals()
		{
		}

		public CGreaterThanEquals(CValue arg1, CValue arg2)
		{
		...
		{
			return new CGreaterThanEquals(arg1, arg2);
		}
	}
}
