...
{
	public class FigureCellRenderer : GridTextBoxCellRenderer
	{
		public FigureCellRenderer(GridControlBase grid, GridTextBoxCellModel cellModel) : base(grid, cellModel)
		{
			this.AddButton(new FigureButton(this));
		}
