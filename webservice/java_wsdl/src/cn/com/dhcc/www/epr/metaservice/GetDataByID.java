...
/**
 *  GetDataByID bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetDataByID implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetDataByID", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetDataByID", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetDataByID parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            GetDataByID object = new GetDataByID();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetDataByID".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetDataByID) cn.com.dhcc.www.epr.metaservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
