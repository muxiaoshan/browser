/**
 * GetKBDiagnosIDByEpisodeID.java
 *
...
/**
 *  GetKBDiagnosIDByEpisodeID bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetKBDiagnosIDByEpisodeID implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetKBDiagnosIDByEpisodeID", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetKBDiagnosIDByEpisodeID", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetKBDiagnosIDByEpisodeID parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetKBDiagnosIDByEpisodeID object = new GetKBDiagnosIDByEpisodeID();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetKBDiagnosIDByEpisodeID".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetKBDiagnosIDByEpisodeID) cn.com.dhcc.www.epr.metaservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
