...
/**
 *  GetNormalData bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetNormalData implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetNormalData", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetNormalData", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetNormalData parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetNormalData object = new GetNormalData();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetNormalData".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetNormalData) cn.com.dhcc.www.epr.metaservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
