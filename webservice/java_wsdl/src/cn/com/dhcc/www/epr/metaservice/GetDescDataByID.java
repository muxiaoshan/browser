...
/**
 *  GetDescDataByID bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetDescDataByID implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetDescDataByID", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetDescDataByID", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetDescDataByID parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetDescDataByID object = new GetDescDataByID();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetDescDataByID".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetDescDataByID) cn.com.dhcc.www.epr.metaservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
