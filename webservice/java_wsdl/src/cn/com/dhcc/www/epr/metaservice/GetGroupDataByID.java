...
/**
 *  GetGroupDataByID bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetGroupDataByID implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetGroupDataByID", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetGroupDataByID", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetGroupDataByID parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetGroupDataByID object = new GetGroupDataByID();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetGroupDataByID".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetGroupDataByID) cn.com.dhcc.www.epr.metaservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
