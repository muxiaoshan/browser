...
/**
 *  GetParentGroupList bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetParentGroupList implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetParentGroupList", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetParentGroupList", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetParentGroupList parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetParentGroupList object = new GetParentGroupList();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetParentGroupList".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetParentGroupList) cn.com.dhcc.www.epr.metaservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
