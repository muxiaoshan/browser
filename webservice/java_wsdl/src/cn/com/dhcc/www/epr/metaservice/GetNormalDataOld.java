...
/**
 *  GetNormalDataOld bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetNormalDataOld implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":GetNormalDataOld", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "GetNormalDataOld", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GetNormalDataOld parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetNormalDataOld object = new GetNormalDataOld();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"GetNormalDataOld".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetNormalDataOld) cn.com.dhcc.www.epr.metaservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
